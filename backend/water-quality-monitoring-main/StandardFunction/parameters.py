...
def TEMP(geometry, start_date, end_date, name= None, print_data=True):
    if name:
        ...
        if cached_data:
            return cleaner(name= "TEMP", data= cached_data["TEMP"], max_val= 50, min_val= 0, window_size= 3, allowed_deviation= 10)
    ...
    cleaned_data = cleaner(name= "TEMP", data= values, max_val= 50, min_val= 0, window_size= 3, allowed_deviation= 10)
...
def NDCI(geometry, start_date, end_date, name= None, print_data=True):
    if name:
        ...
        if cached_data:
            return cleaner(name= "NDCI", data= cached_data["NDCI"], max_val= 1, min_val= -1, window_size= 3, allowed_deviation= 0.1)
    ...
    cleaned_data = cleaner(name= "NDCI", data= values, max_val= 1, min_val= -1, window_size= 3, allowed_deviation= 0.1)
    d1 = tuple(values.items())
...
def BOD(geometry, start_date, end_date, name= None, print_data=True):
    if name:
        ...
        if cached_data:
            return cleaner(name= "BOD", data= cached_data["BOD"], max_val= 30, min_val= 0, window_size= 3, allowed_deviation= 5)
    ...
    cleaned_data = cleaner(name= "BOD", data= values, max_val= 30, min_val= 0, window_size= 3, allowed_deviation= 5)
    d1 = tuple(values.items())
...
def DOM(geometry, start_date, end_date, name= None, print_data=True):
    if name:
        ...
        if cached_data:
            return cleaner(name= "DOM", data= cached_data["DOM"], max_val= 30, min_val= 0, window_size= 3, allowed_deviation= 5)
    ...
    cleaned_data = cleaner(name= "DOM", data= values, max_val= 30, min_val= 0, window_size= 3, allowed_deviation= 5)
    d1 = tuple(values.items())
...
def SM(geometry, start_date, end_date, name= None, print_data=True):
    if name:
        ...
        if cached_data:
            return cleaner(name= "SM", data= cached_data["SM"], max_val= 500, min_val= 0, window_size= 3, allowed_deviation= 50)
    ...
    cleaned_data = cleaner(name= "SM", data= values, max_val= 500, min_val= 0, window_size= 3, allowed_deviation= 50)
    d1 = tuple(values.items())
...
def NT(geometry, start_date, end_date, name= None, print_data=True):
    if name:
        ...
        if cached_data:
            return cleaner(name= "NT", data= cached_data["NT"], max_val= 500, min_val= 0, window_size= 3, allowed_deviation= 50)
    ...
    cleaned_data = cleaner(name= "NT", data= values, max_val= 500, min_val= 0, window_size= 3, allowed_deviation= 50)
    d1 = tuple(values.items())
...
def FC(geometry, start_date, end_date, name= None, print_data=True):
    if name:
        ...
        if cached_data:
            return cleaner(name= "FC", data= cached_data["FC"], max_val= 500, min_val= 0, window_size= 3, allowed_deviation= 50)
    ...
    cleaned_data = cleaner(name= "FC", data= values, max_val= 500, min_val= 0, window_size= 3, allowed_deviation= 50)
    d1 = tuple(values.items())
...
def PH(geometry, start_date, end_date, name= None, print_data=True):
    if name:
        ...
        if cached_data:
            return cleaner(name= "PH", data= cached_data["PH"], max_val= 10, min_val= 4, window_size= 3, allowed_deviation= 1)
    ...
    cleaned_data = cleaner(name= "PH", data= values, max_val= 10, min_val= 4, window_size= 3, allowed_deviation= 1)
    d1 = tuple(values.items())
...
def DO(geometry, start_date, end_date, name= None, print_data=True):    
    if name:
        ...
        if cached_data:
            return cleaner(name= "DO", data= cached_data["DO"], max_val= 14, min_val= 0, window_size= 3, allowed_deviation= 2)
    ...
    cleaned_data = cleaner(name= "DO", data= cached_data["DO"], max_val= 14, min_val= 0, window_size= 3, allowed_deviation= 2)
...
def cleaner(name, data, max_val, min_val, window_size, allowed_deviation):
    ...
    # Normal Outliers using 3-day moving average
    df["Moving_Avg"] = df[name].rolling(
        window=window_size, center=True).mean()

    # Identify Normal Outliers
    df["Deviation"] = abs(df[name] - df["Moving_Avg"])
    df["Outlier"] = df["Deviation"] > allowed_deviation

    # Replace outliers with the moving average
    df.loc[df["Outlier"], name] = df["Moving_Avg"].round(2)

    # Drop intermediate columns used for computation
    df.drop(columns=["Moving_Avg", "Deviation", "Outlier"], inplace=True)

    # cleaned DataFrame back to dictionary
    cleaned_data = dict(
        zip(df["Date"].dt.strftime("%Y-%m-%d"), df[name]))
